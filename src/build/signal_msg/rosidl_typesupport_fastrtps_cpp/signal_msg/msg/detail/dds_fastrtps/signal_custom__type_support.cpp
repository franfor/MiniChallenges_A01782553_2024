...
#include "signal_msg/msg/detail/signal_custom__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const signal_msg::msg::SignalCustom & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  signal_msg::msg::SignalCustom & ros_message)
{
  // Member: signaltype
  cdr >> ros_message.signaltype;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_signal_msg
max_serialized_size_SignalCustom(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = signal_msg::msg::SignalCustom;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const signal_msg::msg::SignalCustom *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<signal_msg::msg::SignalCustom *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SignalCustom__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const signal_msg::msg::SignalCustom *>(
...
static size_t _SignalCustom__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SignalCustom(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SignalCustom__callbacks = {
  "signal_msg::msg",
  "SignalCustom",
...
static rosidl_message_type_support_t _SignalCustom__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SignalCustom__callbacks,
...
{
  return &signal_msg::msg::typesupport_fastrtps_cpp::_SignalCustom__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, signal_msg, msg, SignalCustom)() {
  return &signal_msg::msg::typesupport_fastrtps_cpp::_SignalCustom__handle;
}
